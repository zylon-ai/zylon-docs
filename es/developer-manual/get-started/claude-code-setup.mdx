...
<Note>
  Esta integración se verificó con **Claude Code 2.1.166** en **macOS** usando **Zylon 1.57.1**. Si no funciona, consulta otras alternativas en la [guía de configuración de Opencode](./opencode-setup).
</Note>

## Versiones probadas

| Versión de Zylon | Versión de Claude Code | Sistema operativo | Resultado |
|---|---|---|---|
| 1.57.1 | 2.1.166 | macOS | Funcionando |
