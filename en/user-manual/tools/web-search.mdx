...
<Warning>
    Ask your IT administrator to enable the Web Search tool in your system configuration [with the Operator Manual](/en/operator-manual/configuration/features).
</Warning>
