...
![Screenshot 2025-04-07 at 11.23.17.png](sharepoint-images/Screenshot_2025-04-07_at_11.23.17.png)

2. Click on `Redirect URIs`

![image.png](sharepoint-images/image.png)

3. Click on `Add a platform`

![image.png](sharepoint-images/image%201.png)

4. Click on `Single-Page application`

![image.png](sharepoint-images/image%202.png)
...
![image.png](sharepoint-images/image%203.png)
...
![imagen.png](sharepoint-images/imagen%201.png)
...
![image.png](sharepoint-images/image%204.png)
...
- clientId → value generated on [step 10](sharepoint-images.md)
- clientSecret → value generated on [step 11](sharepoint-images.md)
- redirectUri → same value as [step 4](sharepoint-images.md)
- domain → Your sharepoint url
- client_tenant_id → same value as [step 10](sharepoint-images.md)
