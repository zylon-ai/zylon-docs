...
(o si usas un puerto no estándar, `\\\\files.example.com@445\\zylon-samba`).
 ...
 \\\\files.example.com\\zylon-samba
  ...
  6. Cuando se solicite, ingresa tu **Nombre de usuario** y **Contraseña** de Samba, luego haz clic en **Aceptar**.
  7. Si la conexión tiene éxito, la nueva unidad mapeada (ej., `Z:`) aparecerá bajo **Este equipo**, y puedes navegar su contenido.
