...
description: "Automatically ingest, analyze, and summarize company consolidated financial statements and historical stock prices, 
returning a concise financial snapshot."
---
...
def extract_response_text(response: dict) -> str:
    ...
    for item in reversed(contents):  # Busca desde el último para capturar la respuesta final
