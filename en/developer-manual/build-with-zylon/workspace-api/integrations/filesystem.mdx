...
| --- | --- | --- | --- |
| Path | `integrationID` | Yes | Integration identifier. |
| Body | `username` | Yes | Filesystem username. |
| Body | `password` | Yes | Filesystem password. |
</Accordion>
...
| Type | Name | Required | Notes |
| --- | --- | --- | --- |
| Query | `username` | Yes | Filesystem username to validate. |
| Query | `password` | Yes | Filesystem password to validate. |
</Accordion>
...
| Type | Name | Required | Notes |
| --- | --- | --- | --- |
| Query | `integrationId` | Yes | Filesystem integration identifier. |
</Accordion>
