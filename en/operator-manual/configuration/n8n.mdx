...
First, ensure you have completed all the steps in the [manual SSL certificates installation guide](/en/operator-manual/installation/install#step-6-optional-manually-installing-ssl-certificates).
