...
This sample demonstrates how to use the Zylon platform to ingest, query, and analyze Apple’s (AAPL) financial documents and historical stock 
price data. 

The financial statements and historical price data used in this example are sourced as follows:
- **Consolidated financial statements**: Directly retrieved from Apple's official newsroom:
  - [FY25 Q2 Consolidated Financial Statements](https://www.apple.com/newsroom/pdfs/fy2025-q2/FY25_Q2_Consolidated_Financial_Statements.pdf)
  - [FY25 Q3 Consolidated Financial Statements](https://www.apple.com/newsroom/pdfs/fy2025-q3/FY25_Q3_Consolidated_Financial_Statements.pdf)
- **Historical stock prices**: Fetched programmatically via the `yfinance` Python library, ensuring up-to-date market data for analysis.
...
- A Zylon API token (see [Backoffice Developer Console](/en/developer-manual/get-started/developer-console))
