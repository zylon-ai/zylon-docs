...
| --- | --- | --- | --- |
| Query | `start_date` | No | Start of the reporting window as a Unix timestamp. |
| Query | `end_date` | No | End of the reporting window as a Unix timestamp. |
| Query | `limit` | No | Maximum number of ranked users to return. |
</Accordion>
...
| Query | `start_date` | No | Start of the reporting window as a Unix timestamp. |
| Query | `end_date` | No | End of the reporting window as a Unix timestamp. |
| Query | `limit` | No | Maximum number of ranked projects to return. |
</Accordion>
...
| Query | `start_date` | No | Start of the reporting window as a Unix timestamp. |
| Query | `end_date` | No | End of the reporting window as a Unix timestamp. |
| Query | `type` | Yes | Metric type to return, such as `interactions`. |
</Accordion>
