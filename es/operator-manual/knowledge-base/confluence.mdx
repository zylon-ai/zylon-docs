...
![image.png](/images/operator-manual/knowledge-base/confluence-images/image_1.png)

1. En distribución:
    - En el menú izquierdo navega a `Distribution`
    - Haz clic en `Edit`

![image.png](/images/operator-manual/knowledge-base/confluence-images/image_2.png)
...
- Si tienes una política de privacidad, proporciona el enlace a ella. Si no, usa el enlace por defecto: [`https://example.com/privacy`](https://example.com/privacy), que está destinado para uso interno.
- Para la pregunta "¿Tu aplicación almacena datos personales?", selecciona `No`

![image.png](/images/operator-manual/knowledge-base/confluence-images/image_3.png)
...
![image.png](/images/operator-manual/knowledge-base/confluence-images/image_4.png)

![image.png](/images/operator-manual/knowledge-base/confluence-images/image_5.png)

1. Haz clic en `Granual scopes` y luego en `Edit scopes`

![image.png](/images/operator-manual/knowledge-base/confluence-images/image_6.png)
...
![image.png](/images/operator-manual/knowledge-base/confluence-images/image_7.png)

![image.png](/images/operator-manual/knowledge-base/confluence-images/image_8.png)

1. En autorización:
- En el menú izquierdo, navega a **`Authorization`**.
- Haz clic en **`Add`** para **`OAuth 2.0 (3LO)`**.

![image.png](/images/operator-manual/knowledge-base/confluence-images/image_9.png)

1. En autorización:
- En el campo **`Callback URL`**, ingresa:
`https://zylon.company.com/api/app/integration/confluence/callback`Reemplaza **`zylon.company.com`** con el hostname donde está instalado Zylon en tu servidor.
- Haz clic en **`Save changes`**.

![image.png](/images/operator-manual/knowledge-base/confluence-images/image_10.png)
...
Necesitarás estos valores para el siguiente paso: [Configurar Zylon para usar la Aplicación de Atlassian](#configure-zylon-to-use-atlassian-application)

![image.png](/images/operator-manual/knowledge-base/confluence-images/image_11.png)
