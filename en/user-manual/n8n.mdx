...
![n8n MCP Integration with Zylon](/images/user-manual/n8n-zylon.png)
...
- Having a Zylon API token (see [Backoffice Developer Console](/en/developer-manual/get-started/developer-console))
