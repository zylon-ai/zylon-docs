...
- Añade membresías/roles adicionales con el endpoint de unión a organización en [Backoffice API - Cuentas](/es/developer-manual/build-with-zylon/backoffice-api/accounts#unirse-a-una-organización).
