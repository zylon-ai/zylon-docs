...
| Tool                  | Purpose                          |  |
|-----------------------|----------------------------------|-----------|
| `semantic_search_v1`  | Perform semantic search across documents | [Semantic Search Tool](/en/api-reference/tools/built-in/semantic_search-tool) |
...
| `web_extract_v1`      | Extract and analyze web content          | [Web Extract Tool](/en/api-reference/tools/built-in/web_extract-tool) |
| `database_query_v1`   | Execute SQL database operations          | [Database Query Tool](/en/api-reference/tools/built-in/database_query-tool) |
