...
<Update label="1.46.1" description="September 24, 2025">
  ...
  - Fixed a bug in draft that could cause unexpected crashes in creation.
  - Fixed sync ingestion endpoint.
  - Fixed a bug that could cause to the LLM to get stuck in processing loops.
  ...
  - Fixed a bug that avoid to Triton to load when the vision model is enabled.
</Update>
