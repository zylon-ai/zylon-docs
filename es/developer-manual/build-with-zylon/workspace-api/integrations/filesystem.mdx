...
| Body | `username` | Si | Usuario de Filesystem. |
| Body | `password` | Si | Contraseña de Filesystem. |
</Accordion>
...
| Tipo | Nombre | Obligatorio | Notas |
| --- | --- | --- | --- |
| Query | `username` | Si | Usuario de Filesystem a validar. |
| Query | `password` | Si | Contraseña de Filesystem a validar. |
</Accordion>
...
| Tipo | Nombre | Obligatorio | Notas |
| --- | --- | --- | --- |
| Query | `integrationId` | Si | Identificador de la integración Filesystem. |
</Accordion>
