...
- Tu firewall no está bloqueando conexiones a ningún sitio web.
  - En caso de que ejecutes en un entorno restringido, consulta las [instrucciones semi-airgap](/es/operator-manual/semi-airgap)
...
<Danger>
  **¡Las actualizaciones del kernel (como las actualizaciones desatendidas de Ubuntu) romperán los controladores Nvidia en cada cambio!.**
  ...
  Consulta la siguiente página para solución de problemas: [Solución de Problemas de Controladores Nvidia](/es/operator-manual/nvidia-drivers-troubleshooting)
</Danger>
