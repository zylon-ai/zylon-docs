...
<Update label="1.58.0" description="TBD">
  <Danger>
    **⚠️ Action required before updating to version 1.58.X**

    Follow the complete [1.58 migration guide](/en/changelog/guides/1-58-0) before updating.
  </Danger>
...
<Update label="1.57.0" description="August 17, 2026">
  <Danger>
    **⚠️ Action required before updating to version 1.57.X**

    Follow the complete [1.57 migration guide](/en/changelog/guides/1-57-0) before updating.
  </Danger>

  ## 💼 Workspace
  ### ✨ Features

  - **Skills**: Teach your Zylon agent to perform complex tasks with ready-made instruction packs. [Check more](/en/user-manual/skills/introduction-to-skills)
  - **Organization Skills**: Add and manage Skills at the organization level, enabling centralized skill deployment across workspaces. [Check more](/en/user-manual/managing-organization-skills)
  - **Google Drive Integration**: Connect your Google Drive directly to Zylon for seamless document access and collaboration. [Check more](/en/user-manual/connectors/google-drive)
  - **Guardrails UI**: Visual interface to configure and manage AI guardrails for safer, more controlled interactions. [Check more](/en/operator-manual/backoffice/guardrails)
  - **Session Freshness**: Improved session handling with automatic freshness checks to maintain connection stability.
  - **Attach documents in chat**: Drop images and documents straight into a chat message so Zylon can read and use them as context. [Check more](/en/user-manual/tools/attachments)
  - **Block downloads by org admin configuration**: Admins can now block downloads of uploaded Knowledge Base files and AI-generated resources at the organization level. [Check more](/en/user-manual/block-resource-downloads)

  ## 🛠️ Platform
  ### ✨ Features

  - **Resource Monitor**: New API to monitor system resources and AI workload metrics in real-time.
  - **ARM64 Support**: Full support for ARM64 architecture deployments.
  - **Improved performance**: Faster inference, better concurrency management, and more performant web search.
...
<Update label="1.56.0" description="June 17, 2026">
  ...
  - **Full enterprise redesign**: The Workspace has been fully redesigned with a new look and feel tailored for enterprise environments.
  - **Knowledge Base redesign**: The Knowledge Base has been fully redesigned to be far more flexible.
    - Drop entire folders from your system into the Knowledge Base.
    - Navigate inside folders with a macOS-style double-click interaction.
    - Upload documents or folders directly into a specific folder.
    - Select multiple documents or folders and move them.
    - Use a context menu with right click support.
  - **Agent Flows renamed to AI Documents**: Agent Flows are now called AI Documents across the product.
  - **Improved support for smaller screens**: Although Zylon is not a mobile app, the new redesign significantly improves the experience on smaller screens.

  ## 🛠️ Backoffice
  ### ✨ Features

  - **Usage dashboard for token consumption**: Backoffice now includes a usage dashboard to track token consumption. This feature requires [audit logging](/en/operator-manual/configuration/features/feat-audit) to be enabled.

  ## 🛠️ Platform
  ### ✨ Features

  - **Audit logs for SIEM and security workflows**: Zylon now provides stronger auditability and security log workflows for SIEM integrations and operational reviews. See [Auditability & AI Governance](/en/operator-manual/auditability-ai-safety/), [log delivery and storage](/en/operator-manual/backoffice/log-delivery-storage), and the [Backoffice logging API](/en/developer-manual/build-with-zylon/backoffice-api/logging).
  - **Log retention policy controls**: Added retention policy support for stored logs. See [hard delete configuration](/en/operator-manual/configuration/cron-tasks/hard-delete).
  - **Active Directory / LDAP support**: Zylon now supports enterprise directory integration through [Active Directory / LDAP](/en/operator-manual/authentication/ldap).
  - **One-time password for root admin after every CLI login**: Root administrator access through the CLI now requires a one-time password after every login. See [CLI configuration](/en/operator-manual/configuration/cli).
  - **Vision-based PPTX extraction pipeline**: Added a new pipeline for PPTX files that leverages vision models to improve the accuracy and quality of information extraction. See [vision-based file processing](/en/operator-manual/configuration/features/feat-file-vision).

  ### 🐛 Bug Fixes

  - Fixed a bug that could sometimes cause MCPs to fail a chat even when they were not selected.
  - **Improved memory management in Web Search**: Improved memory management in the [Web Search tool](/en/user-manual/tools/web-search).
  - Delivered multiple UI fixes and polish updates as part of the redesign rollout.
...
<Update label="1.51.0" description="December 16, 2025">
  ...
  - **Duplicate AI Document for Running Flows**: You can now duplicate AI Documents even while they are still running, enabling faster iteration and experimentation.
...
<Update label="1.47.1" description="October 3, 2025">
  ...
  - **Image Support in Chats**: You can now chat with your images, _if the image model is enabled_.
...
<Update label="1.46.2" description="September 24, 2025">
  ...
  - Fixed a bug that could cause crashes when setting up new AI Documents.
  - Fixed a rare issue that could cause the AI to get stuck while processing requests.
  - Fixed a bug where new AI Documents couldn’t be created if a title wasn’t generated automatically.
...
- AI Document - New menu options for an enhanced user experience:
...
- Display the last update time for AI Documents.
...
<Update label="1.43.1" description="September 10, 2025">
  ...
  ### ✨ Features
  - 🔎 **Omnisearch**: Now able to search for content inside AI Documents and Knowledge Base Documents
  ...
  - Prevented users from navigating to deleted AI Documents via Omnisearch
...
<Update label="1.40.1" description="August 21, 2025">
  ...
  - 🔎 **Omnisearch**: Instantly search through your content to quickly navigate to your resources: Documents, Chats, AI Documents.
...
<Update label="1.37.1" description="August 7, 2025">
  ...
  - Export AI Document to PDF/DOCX
...
<Update label="1.29.0" description="June 17, 2025">
  ...
  **Bugfixes and improvements:**
  ...
  - Changing content of AI Documents threw an error even though the content was saved properly
...
<Update label="1.28.5" description="May 30, 2025">
  ...
  Similar to AI Documents, now chats get an automatic name based on the initial message from the user
...
<Update label="1.27.3" description="May 13, 2025">
  ...
  **Bugfixes and improvements:**
  ...
  - UI performance
  - Improve readability in long columns in tables inside AI Documents
  ...
  - Project organization overview UI has been improved. Now you can easily check for private, shared and pinned
    projects.
  - Sources in BulkQ&A AI Documents now point to the document reference instead of showing the filename and page.
...
<Update label="1.23.1" description="April 7, 2025">
  ...
  We've completely revamped the text editor in AI Documents, focusing on improved functionality and a better user
  experience:
  ...
  The platform now supports the popular EML email format. Upload your .eml files and use them in Chats and AI Documents
