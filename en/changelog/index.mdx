...
<Tip>
Recall [how to update Zylon.](/en/operator-manual/update)
</Tip>
</Update>
...
<Update label="1.48.1" description="October 27, 2025">
  ## 🛠️ Platform
  ### ✨ Features
  - Zylon now offers proxy support. Learn more about it [here](/en/operator-manual/proxy).
...
<Update label="1.47.1" description="October 3, 2025">
  ...
  - **MCP Connector Integration**: You can now use MCP connectors in your Zylon instance.
    - This feature is in **Alpha phase** and [needs to be enabled](/en/operator-manual/configuration/experimental-features).
