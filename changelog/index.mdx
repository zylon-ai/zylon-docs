...
## Workspace
### ✨ Features
- Enhanced Slides Extraction thanks to Vision Language Model (VLM). Please check alternatives presets to understand [how to configure and enable it](/operator-manual/configuration/ai-presets#vision-enabled-alternatives).
