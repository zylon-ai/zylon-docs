...
```bash
curl -i "https://{BASE_URL}/api/v1/app/integration/confluence/conf_8a7b6c5d4e3f2a1b/login"
```
...
```bash
curl -i "https://{BASE_URL}/api/v1/app/integration/sharepoint/sp_1c2d3e4f5a6b7c8d/login"
```
...
```bash
curl -X POST "https://{BASE_URL}/api/v1/app/integration/confluence/conf_8a7b6c5d4e3f2a1b/refresh_token" \
...
```bash
curl -X POST "https://{BASE_URL}/api/v1/app/integration/sharepoint/sp_1c2d3e4f5a6b7c8d/refresh_token" \
  -H "Authorization: Bearer {API_TOKEN}"
```
