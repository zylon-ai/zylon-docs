...
## ConfluenceLocalLegacy endpoints

Use these endpoints when your deployment uses the `confluencelocallegacy` provider with basic-auth credentials.

### Create a ConfluenceLocalLegacy integration
...
### Update a ConfluenceLocalLegacy integration
...
### Get ConfluenceLocalLegacy config
...
### Start ConfluenceLocalLegacy ingest
