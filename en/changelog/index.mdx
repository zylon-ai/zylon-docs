...
<Update label="1.54.0" description="March 09, 2026">
  ...
  ### 🐛 Bug Fixes
    ...
    - Resolved issue where files linked in the Knowledge Base remained accessible after a user left a project.
  ...
  - **Backoffice:**  The Platform Backoffice is used by Operators to manage platform-level access and developer environments. [Check more.](/en/user-manual/backoffice/introduction)
  - **AI Gateways:** A dedicated, isolated software service that sits at the boundary between clients and Zylon's internal APIs. [Check more.](/en/user-manual/backoffice/platform-backoffice#gateways)
