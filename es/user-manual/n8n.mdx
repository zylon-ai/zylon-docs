...
![Integración de n8n MCP con Zylon](/images/user-manual/n8n-zylon.png)
...
- Contar con un token de API de Zylon (consulta [Backoffice Developer Console](/es/developer-manual/get-started/developer-console))
