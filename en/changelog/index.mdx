...
<Update label="1.46.2" description="September 24, 2025">
  ...
  - Use your own AI models: You can now plug in your own fine-tuned AI models without losing any of the platform's features. This gives you more control and flexibility over how the AI behaves. More information in customizing the default presets.
