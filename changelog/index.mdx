...
<Update label="1.51" description="December 16, 2025">
    ...
    ## 💼 Workspace
    ### ✨ Features
    - **Attach Images and Audios in Chat**: You can now attach images and audios directly in chat conversations. This feature requires your model to support image or audio capabilities.
    - **Project-Level Connectors**: MCPs and Databases can now be configured at the **project level**, making them reusable across multiple agents and flows while maintaining consistent access control.
    - **Web Search Tool in Chat**: Web Search is now available directly inside chat, enabling users to fetch up-to-date information without leaving the conversation.
