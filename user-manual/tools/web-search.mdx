...
> Tip: If your project uses **Pre-selected tools**, an admin can configure Web search to be enabled by default for new chats—making it easier for non-technical users to always get current information.
