...
2. **Update configuration**: Run `sudo zylon-cli config init --force` to update the configuration for online operation. Be sure to configure as [Configure Zylon](#configure-zylon) step describes.
