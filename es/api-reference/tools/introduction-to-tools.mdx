...
|-----------------------|----------------------------------|-----------|
| `semantic_search_v1`  | Realizar búsqueda semántica en documentos | [Herramienta de búsqueda semántica](/es/api-reference/tools/built-in/semantic-search-tool) |
...
| `web_extract_v1`      | Extraer y analizar contenido web          | [Herramienta de extracción web](/es/api-reference/tools/built-in/web-extract-tool) |
| `database_query_v1`   | Ejecutar operaciones de base de datos SQL          | [Herramienta de consulta de base de datos](/es/api-reference/tools/built-in/database-query-tool) |
