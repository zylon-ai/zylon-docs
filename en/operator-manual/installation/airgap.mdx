---
title: "Full-Airgap Installation"
...
<Steps>
  ...
  <Step title="Download AI Models">
    _Estimated time: 10min to 1h, depending on network speed and models._
    ...
    **Before downloading Zylon**, you must download the AI models on the online machine. The models are determined by your AI preset configuration.
    ...
    For example, for `baseline-24g` preset:
    ```bash
  ...
  <Step title="Export AI Models">
    _Estimated time: 5 to 30 min, depending on models size._
  ...
  <Step title="Export Bundle">
    _Estimated time: 15 to 60 min, depending on version._
...
<Steps>
  ...
  <Step title="Import AI Models">
    _Estimated time: 5 to 30 min, depending on model sizes._
    ...
    **Before importing Zylon**, import the AI models that were exported on the online machine:
    ...
    This command will import and install the AI models automatically.
...
<Steps>
  <Step title="On Online Machine: Download New Models (If Needed)">
    _Estimated time: 10 to 60 min (only if adding new models)_
  ...
  <Step title="On Online Machine: Export New Models (If Applicable)">
    _Estimated time: 5 to 30 min (only if new models were downloaded)_
  ...
  <Step title="On Offline Machine: Import New Models (If Applicable)">
    _Estimated time: 5 to 30 min (only if new models were transferred)_
  ...
  <Step title="On Offline Machine: Install New Models (If Applicable)">
    _Estimated time: 2 to 10 min (only if new models were imported)_

    **Skip this step if you didn't import new AI models.**

    Install the newly imported models:
