...
<CardGroup cols={2}>
  ...
  <Card title="Log Delivery and Storage" icon="list" href="/en/operator-manual/backoffice/log-delivery-storage">
    Understand Zylon logging, auditability, traceability, storage, and operational access.
  </Card>
