...
| Capacidad     | Descripción                                   | Casos de Uso de Ejemplo                                       | Modelos                         |
|----------------|-----------------------------------------------|---------------------------------------------------------|--------------------------------|
| `multilingual` | Soporte mejorado para idiomas más allá del inglés | Documentos internacionales, procesamiento de contenido no inglés | intfloat/multilingual-e5-large |
