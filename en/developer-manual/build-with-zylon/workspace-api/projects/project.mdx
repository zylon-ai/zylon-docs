...
| --- | --- | --- | --- |
| Path | `projectID` | Yes | Project identifier. |
| Body | `old_owner_ws_member_id` | Yes | Current owner's workspace member ID. |
| Body | `new_owner_ws_member_id` | Yes | New owner's workspace member ID; must identify a project member. |
</Accordion>
...
## Project workspace member info

Get project information for a specified workspace member, or update it for the currently authenticated workspace member.

<Tabs>
  <Tab title="Get member info">
<Accordion title="Endpoint parameters">
| Type | Name | Required | Notes |
| --- | --- | --- | --- |
| Path | `projectID` | Yes | Project identifier. |
...
```
  ...
  <Tab title="Update current member info">
<Accordion title="Endpoint parameters">
| Type | Name | Required | Notes |
| --- | --- | --- | --- |
| Path | `projectID` | Yes | Project identifier. |
| Body | `is_pinned` | Yes | Pins or unpins the project for the currently authenticated workspace member. |
</Accordion>
