...
## 💼 Workspace
### ✨ Features
- Database Connector: Connect seamlessly to PostgreSQL, MySQL, DB2 and MSSQL databases and ask questions in chats, enabling intuitive data retrieval without 
writing SQL queries.
  - This feature is in **Alpha phase** and [needs to be enabled](/operator-manual/configuration/experimental-features).
