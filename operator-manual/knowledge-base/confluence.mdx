...
![image.png](confluence-images/image.png)

1. Provide a meaningful name for the Application.

![image.png](confluence-images/image%201.png)

1. On distribution:
    - In the left menu navigate to `Distribution`
    - Click on `Edit`

![image.png](confluence-images/image%202.png)
...
![image.png](confluence-images/image%203.png)
...
![image.png](confluence-images/image%204.png)

![image.png](confluence-images/image%205.png)

1. Click `Granual scopes` and then on `Edit scopes`

![image.png](confluence-images/image%206.png)
...
![image.png](confluence-images/image%207.png)

![image.png](confluence-images/image%208.png)

1. On authorization:
- In the left menu, navigate to **`Authorization`**.
- Click **`Add`** for **`OAuth 2.0 (3LO)`**.

![image.png](confluence-images/image%209.png)
...
![image.png](confluence-images/image%2010.png)
...
![image.png](confluence-images/image%2011.png)
