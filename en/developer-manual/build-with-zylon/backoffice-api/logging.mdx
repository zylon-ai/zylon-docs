...
This page covers manual retrieval only. For external syslog or HTTP delivery, see [Log delivery & Storage configuration](/en/operator-manual/configuration/features/log-delivery-storage).
...
- [Operator Manual: Log delivery & Storage](/en/operator-manual/backoffice/log-delivery-storage)
- [Configuration: Log delivery & Storage](/en/operator-manual/configuration/features/log-delivery-storage)
