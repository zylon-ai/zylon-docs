...
- H100 (server) and A100 80GB are the current baseline references for sizing.
...
In any case, as a direct answer to the question of which GPU should you buy, our current baseline recommendation is a configuration with **at least 96GB of total VRAM**.
