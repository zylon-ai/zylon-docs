...
<Warning>
In airgap mode, `externalConnection.enabled` will always be `false` regardless 
of the configured value ([Semi-airgap installation](/en/operator-manual/semi-airgap))
</Warning>
...
First, ensure you have completed all the steps in the [manual SSL certificates installation guide](/en/operator-manual/install#step-6-optional-:-manually-installing-ssl-certificates).
