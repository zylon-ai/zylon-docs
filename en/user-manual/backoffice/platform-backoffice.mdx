...
- **Developer** role can access Developer Tools.
- **Workspace** role does not grant Platform Backoffice access.

For the full role matrix and permission model, see [Roles and Permissions](/en/user-manual/backoffice/roles-and-permissions).
...
### Gateway user roles
Accounts with the **Developer** role (and Operators added to a gateway) can be assigned a gateway role: **Owner**, **Admin**, or **Member**.

For gateway-role capabilities, see [Roles and Permissions](/en/user-manual/backoffice/roles-and-permissions).
