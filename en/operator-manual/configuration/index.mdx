...
<CardGroup cols={2}>
  ...
  <Card title="Omnisearch" icon="magnifying-glass" href="/en/operator-manual/configuration/search">
    Configure keyword-search languages and the maximum query length
  </Card>
  ...
  <Card title="System Monitor" icon="gauge-high" href="/en/operator-manual/configuration/features/feat-system-monitor">
    Enable live host-resource and model-serving metrics in Backoffice
  </Card>
