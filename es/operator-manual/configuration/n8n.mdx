...
Primero, asegúrate de haber completado todos los pasos de la [guía de instalación de certificados SSL manuales](/es/operator-manual/installation/install#step-6-optional-manually-installing-ssl-certificates).
