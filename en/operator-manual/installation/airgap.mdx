...
<Steps>
  ...
  <Step title="Install AI Models">
    _Estimated time: 2 to 10 min_

    After importing the models, install them:

    ```bash
    sudo zylon-cli models install
    ```

    This will install the AI models that were imported in the previous step.
