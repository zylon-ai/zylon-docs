...
<Note>
Workspace-only tokens are not enough for Backoffice endpoints. Interactive sessions continue to use their role permissions and are not restricted by API token scopes.
</Note>
