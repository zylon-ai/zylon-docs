...
- `-u, --unsafe`: Don't stop k0s before backup, this might cause data corruption but won't cause downtime
- `-y, --yes`: Ask user for confirmation
...
- `--yes`: Skip prompts and assume yes for all questions
...
- `-e, --email-regex`: All emails matching this regex will be allowed to join the organizationUsually this would be .*@\.yourdomain\.com
