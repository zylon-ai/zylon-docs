...
The [Quick Start Guide](/user-manual/quick-start-guide) walks through this process step by step.
...
However, reviewing the [Beginner's Guide to Chat](/user-manual/beginners-guide-to-chat) will help you get better results faster.
