...
<Card title="Write Content" icon="pen-to-square" href="/en/api-reference/introduction">
  Learn MDX syntax and start writing your documentation.
</Card>

<Card title="Customize style" icon="palette" href="/en/operator-manual/configuration/whitelabel">
  Make your docs match your brand perfectly.
</Card>

<Card title="Add code examples" icon="square-code" href="/en/api-reference/examples/stock_analysis">
