...
<Steps>
  ...
  <Step title="Install AI Models">
    ...
    **Before installing Zylon**, you must install the AI models. The models are determined by your AI preset configuration and will be downloaded from Hugging Face domains.
