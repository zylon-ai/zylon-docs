...
## Account creation moved to Accounts
...
To use that account in Workspace, you need at least one workspace user:
...
- Add additional workspace memberships/roles with the join organization endpoint in [Account](/en/developer-manual/build-with-zylon/workspace-api/authentication/account), documented under [Accounts - Join an organization](/en/developer-manual/build-with-zylon/backoffice-api/accounts#join-an-organization).
