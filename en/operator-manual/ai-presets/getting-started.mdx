...
```yaml
ai:
  preset: "baseline-48g"  # Replace with your selected preset
```
...
- Explore [available presets](/en/operator-manual/ai-presets/presets) to find specialized configurations
- Learn about [configuration options](/en/operator-manual/ai-presets/configuration) for multi-GPU and capabilities
- Dive into [advanced customization](/en/operator-manual/ai-presets/advanced-customization) for custom models
- Troubleshoot common issues in the [troubleshooting guide](/en/operator-manual/ai-presets/troubleshooting)
