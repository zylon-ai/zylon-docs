...
- Tu firewall no está bloqueando conexiones a ningún sitio web.
  - En caso de que ejecutes en un entorno restringido, consulta las [instrucciones semi-airgap](operator-manual/semi-airgap)
...
<Tip>
  Para la configuración detallada de la instancia de Zylon, consulta la página de [Configuración](/operator-manual/configuration/index).
</Tip>
...
<Danger>
  **¡Las actualizaciones del kernel (como las actualizaciones desatendidas de Ubuntu) romperán los controladores Nvidia en cada cambio!.**
  ...
  Consulta la siguiente página para solución de problemas: [Solución de Problemas de Controladores Nvidia](/operator-manual/nvidia-drivers-troubleshooting)
</Danger>
