...
<Steps>
  ...
  <Step title="Descargar Bundle de Zylon">
    ...
    <Warning>
      **¡La primera instalación o modelos adicionales requieren modelos de IA!** Usa la bandera `--models` para especificar qué modelos incluir.
      ...
      ```
      Compara con tu definición de preset de IA para determinar los modelos requeridos. Más detalles de preset [aquí](/es/operator-manual/ai-presets/getting-started.mdx).
  ...
  <Step title="Exportar Bundle">
    _Tiempo estimado: 15 a 60 min, dependiendo de los modelos seleccionados y versión._
    ...
    Esto crea `zylon-<version>-airgap.tar` en tu directorio actual. Adicionalmente, generará
...
<Steps>
  ...
  <Step title="En Máquina Online: Crear Bundle de Actualización">
    ...
    **Incluir modelos (si aplica):**
    ...
    Esto genera `zylon-<new-version>-airgap.tar` y muestra los comandos de importación/instalación para ejecutar en la máquina offline también.
