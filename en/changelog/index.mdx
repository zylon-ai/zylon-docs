...
<Update label="1.53.0" description="February 23, 2026">
  <Danger>
    **⚠️ Action required before updating to version ≥ 1.53.0**
    ...
    This release requires CUDA 13.0. If you update without following the steps below, Triton will fail to boot.

    This update involves 45-60 minutes of downtime. Please plan accordingly and notify your users before starting the upgrade process.
