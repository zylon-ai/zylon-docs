...
```yaml
ai:
  preset: "baseline-48g"  # Reemplaza con tu preset seleccionado
```
...
- Explora [presets disponibles](/es/operator-manual/ai-presets/presets) para encontrar configuraciones especializadas
- Aprende sobre [opciones de configuración](/es/operator-manual/ai-presets/configuration) para multi-GPU y capacidades
- Sumérgete en [personalización avanzada](/es/operator-manual/ai-presets/advanced-customization) para modelos personalizados
- Soluciona problemas comunes en la [guía de solución de problemas](/es/operator-manual/ai-presets/troubleshooting)
