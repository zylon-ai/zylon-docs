...
- Un token de API de ZylonGPT asociado a un gateway con `PrivateGPT.ReadWrite.All`, o un token de cuenta con `ReadWrite.All`. Consulta [Gestión de tokens](/es/developer-manual/get-started/token-management).
