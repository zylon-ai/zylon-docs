...
<Note>
  This integration was verified with **Claude Code 2.1.166** on **macOS** using **Zylon 1.57.1**. If it's not working, please check other alternatives in the [Opencode setup guide](./opencode-setup).
</Note>

## Tested versions

| Zylon release | Claude Code version | Operating system | Result |
|---|---|---|---|
| 1.57.1 | 2.1.166 | macOS | Working |
