---
title: Integración con Google (SSO)
---
...
<Warn>
    El archivo de configuración es un archivo `.yaml`, por lo que la indentación, los espacios, los puntos y coma y las
    comillas dobles son relevantes.
</Warn>
