...
For conceptual logging, auditability, EU AI Act-aligned traceability, and retention guidance, see [Operator Manual: Log Delivery and Storage](/en/operator-manual/backoffice/log-delivery-storage). For manual log retrieval, see [Backoffice API: Logging](/en/developer-manual/build-with-zylon/backoffice-api/logging).
