...
The following examples considering a system with 48 CPU cores. Adjust `numWorkers` and `numThreads` based on your system's CPU count and workload characteristics.
...
<AccordionGroup>
  ...
  **What this does**: Middle ground between high throughput and heavy processing. Provides 3 workers for small files and 3 for large files with 6 threads each, balancing concurrency and processing power.
