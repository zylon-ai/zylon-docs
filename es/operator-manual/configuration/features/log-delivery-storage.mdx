...
Para conceptos operativos, auditabilidad, trazabilidad y retencion, consulte [Backoffice: Entrega y almacenamiento de logs](/es/operator-manual/backoffice/log-delivery-storage).
...
| `timezone` | `UTC` | zona horaria | Zona horaria usada por la programacion. Compartida con el borrado permanente. |
