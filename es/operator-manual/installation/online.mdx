...
<Steps>
  ...
  <Step title="Descargar Modelos de IA">
    ...
    **Antes de instalar Zylon**, debes descargar los modelos de IA. Los modelos están determinados por tu configuración de preset de IA.
    ...
    ```bash
    sudo zylon-cli models download txn545/qwen3.5-35b-a3b-nvfp4 mixedbread-ai/mxbai-embed-large-v1
    ```
  </Step>
