...
title: "Changelog"
---
<Update label="1.43.0" description="September 10, 2025">
  <Danger>
  ...
  ### ✨ Features
  - 🔎 **Omnisearch**: Now able to search for content inside Agent Flows
    - Follow the [instructions to enable it](/changelog/guides/1-43-0#post-update)
  - 📝 **Issue reporting**: New filters added to improve usability
...
<Update label="1.42.0" description="September 05, 2025">
  ### ✨ Features
...
<Update label="1.41.0" description="August 28, 2025">
  ### ✨ Features

  - 📝 **Issue reporting**: Users can now report chats to admin organizations when encountering issues with Zylon's responses.

  ![](/changelog/images/1.41.0/image1.png)

  ![](/changelog/images/1.41.0/image2.png)
