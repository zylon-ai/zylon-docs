...
- A gateway-scoped ZylonGPT API token with `PrivateGPT.ReadWrite.All`, or an account token with `ReadWrite.All`. See [Token Management](/en/developer-manual/get-started/token-management).
