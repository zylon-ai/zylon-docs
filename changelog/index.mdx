...
<Update label="1.40.0" description="August 19, 2025">
  ### Features
  - **Folders**: Arrange your knowledge base with folders for better organization of directly uploaded documents
  - **Async chats**: Now you can close Zylon and your chat will finish on background
  - **Omnisearch**: Search through your content to navigate to your resources
  - **Links**: Now they always stay in sync with the original project.

  ### Bugfixes & improvements
  - Custom priorities in chats are taken in consideration in inference time

  ### Platform
  - Deprecated endpoints in Low-Level API have been removed

  <img src="/changelog/images/1.40.0/image1.png"/>
  <img src="/changelog/images/1.40.0/image2.png"/>
...
<Update label="1.39.0" description="August 12, 2025">
  ...
  <img src="/changelog/images/1.39.0/image1.png"/>
</Update>
...
<Update label="1.38.0" description="August 8, 2025">
  ...
  <img src="/changelog/images/1.38.0/image1.png"/>
  <img src="/changelog/images/1.38.0/image2.png"/>
</Update>
