...
<CardGroup cols={3}>
  ...
  <Card title="Notes" icon="note-sticky" href="/en/developer-manual/build-with-zylon/workspace-api/notes/notes">
    Create and manage account-owned notes, optionally linked to a project and artifacts.
  </Card>
</CardGroup>
