...
<Steps>
  ...
  <Step title="Install AI Models">
    ...
    **Before installing Zylon**, you must install the AI models. The models are determined by your AI preset configuration.
    ...
    Install the models based on your configuration:
    ...
    If for some reason you need to install specific models, you can do so with:
