...
To get a better experience during search it's recommended to enable what are the languages you plan to use in Zylon for content (Chats, documents, AI Documents), the default language is `english` but multiple languages can be enabled.
