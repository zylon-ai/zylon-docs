---
title: "Instalar Zylon (Legacy)"
description: "Una guía para instalar Zylon en una sola instancia"
---

<Warning>
  Esta guía solo se aplica a Zylon 1.53.0 o anterior. Para versiones más recientes, el proceso de instalación es diferente y debes referirte a la [guía de instalación principal](/es/operator-manual/installation/index).
</Warning>
...
- Tu firewall no está bloqueando conexiones a ningún sitio web.
  - En caso de que ejecutes en un entorno restringido, consulta las [instrucciones semi-airgap](/es/operator-manual/configuration/network/semi-airgap)
