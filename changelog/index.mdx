...
## 💼 Workspace
### ✨ Features
- **CSV Bulk User Upload** - Upload multiple users at once with integrated seat control management.
- **Password Reset** - Improved password reset functionality.
- **Developer Mode** - Introducing Zylon Developer Mode with enhanced capabilities for technical users.
    - **Token Management** - Developers and Zylon admins can now manage their API tokens directly in the workspace, check [the Developer Manual](/api-reference/token-management) for more information.
### 🐛 Bug Fixes
...
## 🛠️ Platform
### ✨ Features
- **Anthropic API Compatibility** - Platform now supports Anthropic-compatible API endpoints.
- **vLLM Metrics** - Added comprehensive metrics to vLLM v1 for better monitoring and performance tracking.
</Update>
...
<Update label="1.47.1" description="October 3, 2025">
  ...
  - **MCP Connector Integration**: You can now use MCP connectors in your Zylon instance.
    ...
    - Learn how to use it with the [User Manual](/workspace-manual/tools/mcp-connector).
