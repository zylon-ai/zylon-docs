...
- **Acceso**: n8n está disponible en la ruta `/n8n` de tu instancia de Zylon (por ejemplo: `https://tu-instancia-zylon.com/n8n`)
...
([Instalación semi-airgap](/es/operator-manual/configuration/network/semi-airgap))
</Warning>
...
Si necesitas importar workflows o credenciales desde archivos JSON ubicados en tu máquina local, primero debes transferirlos al pod de n8n:
