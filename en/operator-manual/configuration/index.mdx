...
<CardGroup cols={2}>
  <Card title="Feature Overview" icon="toggle-on" href="/en/operator-manual/configuration/features/index">
    Manage feature flags and understand available capabilities
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="CLI Reference" icon="terminal" href="/en/operator-manual/configuration/cli">
    Complete command-line interface reference for managing Zylon
  </Card>
</CardGroup>
...
<Tip>
  Always backup your configuration file before making significant changes: `sudo cp /etc/zylon/zylon-conf.yaml /etc/zylon/zylon-conf.yaml.backup`
</Tip>