...
<CardGroup cols={2}>
  ...
  <Card title="Usage Dashboard" icon="chart-column" href="/en/operator-manual/backoffice/usage-dashboard">
    Monitor AI usage across gateways, API tokens, and Workspace activity.
  </Card>
  <Card title="System Monitor" icon="gauge-high" href="/en/operator-manual/backoffice/system-monitor">
    Inspect live host-resource pressure and model-serving activity.
  </Card>
  ...
  <Card title="Logging, Evidence, and SIEM Delivery" icon="list-check" href="/en/operator-manual/backoffice/log-delivery-storage">
    Understand auditability, traceability, evidence preservation, storage, SIEM delivery, and operational access.
  </Card>
