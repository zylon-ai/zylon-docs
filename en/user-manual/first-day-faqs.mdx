...
The [Quick Start Guide](/en/user-manual/quick-start-guide) walks through this process step by step.
...
However, reviewing the [Beginner's Guide to Chat](/en/user-manual/querying-company-documents) will help you get better results faster.
...
![](/user-manual/images/workspace_citations.png)
