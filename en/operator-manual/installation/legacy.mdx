...
- Your firewall is not blocking connections to any website.
  - In case you run in a restricted environment, check the [semi-airgap instructions](/en/operator-manual/configuration/network/semi-airgap)
