...
<Warning>
El uso de estos presets probablemente requiere modificar la memoria compartida del servidor de inferencia. Consulta la sección [Configuración de Memoria Compartida](/operator-manual/ai-presets/configuration#shared-memory-configuration).
</Warning>
