...
## 🛠️ Platform
### ✨ Features
- **Expand Zylon with your own tools and workflows without additional infrastructure: Zylon** now supports **Messages-style API endpoints**, enabling seamless tool integrations.
