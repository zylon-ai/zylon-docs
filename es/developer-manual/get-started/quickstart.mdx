...
- Un token para la API que vas a usar:
  ...
  - Token de ZylonGPT asociado a un gateway: [Backoffice Developer Console](/es/developer-manual/get-started/developer-console)
...
- **401/403**: token inválido, caducado, sin el scope necesario o emitido para el flujo incorrecto. Usa [Gestión de tokens de Workspace](/es/developer-manual/get-started/token-management) para acceder a Workspace, o [Backoffice Developer Console](/es/developer-manual/get-started/developer-console) para un token de ZylonGPT asociado a un gateway.
