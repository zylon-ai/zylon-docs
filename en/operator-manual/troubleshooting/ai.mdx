...
description: "Troubleshooting guide for diagnosing and improving AI inference performance in Zylon."
---

## Slow Inference Performance

When experiencing slow inference times, first establish a performance baseline.
Use the [VRAM Calculator](https://apxml.com/tools/vram-calculator) to determine your GPU's expected throughput and compare it against your [model specifications](/en/operator-manual/ai-presets/presets).

Zylon provides a benchmarking script that simulates concurrent inference requests to measure Time To First Token (TTFT), latency, and throughput. This can help identify if performance is below expectations and whether it degrades under load.
