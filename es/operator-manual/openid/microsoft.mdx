---
title: Integración con Microsoft Entra (SSO)
---
...
![image.png](/images/operator-manual/openid-images/microsoft/image_1.png)

4. Haz clic en `New Registration`.

![image.png](/images/operator-manual/openid-images/microsoft/image_2.png)
...
![image.png](/images/operator-manual/openid-images/microsoft/image_3.png)

- En caso de que quieras cambiarlo más tarde, puedes hacerlo en `Application Overview`

![image.png](/images/operator-manual/openid-images/microsoft/image_4.png)


5. Guarda el siguiente valor que se usará más tarde en el archivo de configuración para Zylon.
- Application (client) ID

![image.png](/images/operator-manual/openid-images/microsoft/image_5.png)

6. Ahora necesitamos generar el `ClientSecret`. Ve al menú izquierdo y haz clic en `Manage > Certificates & secrets`

<img src="/images/operator-manual/openid-images/microsoft/image_6.png" alt="image.png" width="50%"/>

7. Haz clic en `New client secret` y agrega la información requerida

![image.png](/images/operator-manual/openid-images/microsoft/image_7.png)

8. Copia el `Value` del secreto del cliente.

![image.png](/images/operator-manual/openid-images/microsoft/image_8.png)
...
![image.png](/images/operator-manual/openid-images/microsoft/image_9.png)
